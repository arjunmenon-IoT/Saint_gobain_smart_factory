...
def model_convergence(COMBUSTION_AIR_TEMPERATURE,COMBUSTION_AIR_VOLUMETRIC_FLOW,RECIRCULATION_AIR_VOLUMETRIC_FLOW,CALCINATION_TEMPERATURE,STUCCO_FLOW,AMBIENT_HUMIDITY,AMBIENT_TEMPERATURE,HH,AIII,GYPSUM_PURITY,GYPSUM_MOISTURE):

        # Plant depended Constants
    ...
    while ((energy_Error != 0 or dry_flow_Error != 0 or water_Error != 0) ) :
        ...
        zeroTohundred = [FUEL_PROPERTIES_DENSITY,FUEL_PROPERTIES_COMBUSTION_WATER,AMBIENT_HUMIDITY,COMBUSTION_TEMPERATURE,SYSTEM_FAN_HEAT_RELEASE,RECIRCULATION_AIR_VOLUMETRIC_FLOW,GYPSUM_PURITY,GYPSUM_MOISTURE,HH,AIII,AII,MOISTURE,RECIRCULATION_AIR_VOLUMETRIC_FLOW,AMBIENT_TEMPERATURE,COMBUSTION_AIR_TEMPERATURE]
