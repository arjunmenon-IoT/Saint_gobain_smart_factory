...
recirculation_air_density = 0.000001
recirculated_air_temp = .000001
recirculation_air_dry_flow = .000001
HUMIDITY = .000001
recirculated_air_energy_flow = 0.000001
GAS_FLOW = .000001
 

Aiii_back_conversion_heat_release = .000001      # helps to find the intial gass flow
flow_after_filter_energy = .000001    # helps to find the intial gass flow
In_leakage_in_filter_area_energy_flow =.000001  # helps to find the intial gass flow
input_material_energy_flow = .000001  # helps to find the intial gass flow
stack_energy_flow = 0.000001  # helps to find the intial gass flow
...
''' Combustion '''
Aiii_back_conversion_heat_release = .1
flow_after_filter_energy = .1
In_leakage_in_filter_area_energy_flow =.1
input_material_energy_flow = .1
stack_energy_flow = 0.1
...
""" Recirculation Air""" 
recirculated_air_humidity = middle_state_humidity
recirculated_air_temp = middle_state_temperature
recirculation_air_density =  MVOL(recirculated_air_temp,recirculated_air_humidity,Pressure_Pa_To_mmWC(100*ABSOLUTE_PRESSURE-101325))
recirculation_air_dry_flow = RECIRCULATION_AIR_VOLMETRIC_FLOW*recirculation_air_density/(1+middle_state_humidity/1000)
recirculated_air_energy_flow = CS(recirculated_air_temp,recirculated_air_humidity)*recirculation_air_dry_flow

""" Gass Flow"""
HUMIDITY = recirculated_air_humidity
GAS_FLOW = (((dissociation_dehydration+dissociation_evaporation+drying_evaporation-Aiii_back_conversion_heat_release)+(flow_after_filter_energy)+(wall_losses_from_burner_to_CP_outlet_losses+wall_losses_from_cp_outlet_to_filter_outlet_losses)+(stack_energy_flow))-(input_material_energy_flow+(air_entrainment_energy_flow+In_leakage_in_filter_area_energy_flow)+(combustion_air_energy_flow)+(SYSTEM_FAN_HEAT_RELEASE)))*3600/((FUEL_PROPERTIES_GAS_CALORIFIC_VALUE_HHV*0.901)/860)/860
#GAS_FLOW = combustion_gas_flow_NM3_H
