...
COMBUSTION_TEMPERATURE = 1000 # 0 to 100
SYSTEM_FAN_HEAT_RELEASE =1000 # 0 to 100
RECIRCULATION_AIR_VOLMETRIC_FLOW =1000 # 0 1to 100
GYPSUM_PURITY= 1000 # 0 to 100
GYPSUM_MOISTURE= 1000# 0 to 100
HH=1000 # 0 to 100
AIII = 1000 # 0 to 100
AII = 1000 # 0 to 100
MOISTURE=1000 # 0 to 100
STUCCO_FLOW = 1000 # 0 to 100
WALL_LOSSES_FROM_CP_OUTLET_TO_FILTER_OUTLET_TEMPERATURE =1000 # 0 to 200
WALL_LOSSES_FROM_CP_OUTLET_TO_FILTER_OUTLET_WALL_SURFACE =1000 #cest l'consatnt
AIII_BACK_CONVERSTION_CONVERSION_RATIO = 1000 #cest l'consatnt
CALCINATION_TEMPERATURE= 1000 # 0 to 300
RECIRCULATION_AIR_VOLUMETRIC_FLOW = 1000 # 0 to 100
WALL_LOSSES_FROM_BURNER_TO_CP_OUTLET_TEMPERATURE = 1000 # 0 to 200
WALL_LOSSES_FROM_BURNER_TO_CP_OUTLET_WALL_SURFACE =1000 #cest l'consatnt
