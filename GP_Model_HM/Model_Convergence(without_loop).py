...
output_material_energy_flow = 0.100  # helps to find the intial gass flow
...
while(energy_Error !=0 and  dry_flow_Error != 0 or  water_Errors != 0):
    ...
    """Air entrailment"""
    air_entrainment_density =  MVOL(AMBIENT_TEMPERATURE,AMBIENT_HUMIDITY,Pressure_Pa_To_mmWC(100*ABSOLUTE_PRESSURE-101325))
    air_entrainment_temp = AMBIENT_TEMPERATURE
    air_entrainment_dryflow = AIR_INGRESS_MILL
    air_entrainment_humidity = AMBIENT_HUMIDITY
    air_entrainment_volumetric_flow =  AIR_INGRESS_MILL*(1+air_entrainment_humidity/1000)/air_entrainment_density
