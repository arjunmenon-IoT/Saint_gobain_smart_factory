...
while( state_1== 1):
    ...
    if (min(counter_1,counter_2,counter_3) == 20):
        print(" to second stage",round(combustion_gas_flow_NM3_H))
        state_1= 0
...
list3=[]
list4=[]
while(state_1 ==0 and control_value <2000 ):
    #case1 -  
    ...
    combustion_gas_flow_NM3_H = combustion_gas_flow_NM3_H +1
    list1.append(combustion_gas_flow_NM3_H)
