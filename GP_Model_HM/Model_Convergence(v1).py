...
while( state_1== 1):
    ...
    if( energy_Error == var1  ):
        counter_1 = counter_1 + 1
    
    if(dry_flow_Error == var2):
        counter_2 = counter_2+1
        
    
    if(water_Errors == var3 ):
        counter_3 = counter_3+1
        
    if (min(counter_1,counter_2,counter_3) == 20):
        print(" to second stage",round(bridge_flow_temp))
        state_1= 0
...
list3=[]
list4=[]
while(control_value <5000 ):
    #case1 -  
    

    ''' Combustion '''
    combustion_gas_flow_NM3_H = combustion_gas_flow_NM3_H + combustion_gas_flow_NM3_H*.25
    ...
    dry_flow_Error = round(100*(dry_flow_inputs-dry_flow_outputs)/dry_flow_inputs)
    water_Errors = round(100*(water_iputs-water_outputs)/water_iputs)
    list2.append(energy_Error)
    #list3.append(dry_flow_Error)
    #list4.append(water_Errors)
