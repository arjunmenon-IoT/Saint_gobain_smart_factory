...
'''
def R30(Flow_After_Filter_Temp,Recirculation_Humidity_Calculated,Air_Ingress_Mill,Air_Ingress_Filter,System_fan_Heat_Release,L41) :
     return R30 = TEM(((CS(Flow_After_Filter_Temp,Recirculation_Humidity_Calculated)*L41+Air_Ingress_Mill+ Air_Ingress_Filter))+System_fan_Heat_Release)/( (L41)+Air_Ingress_Mill+Air_Ingress_Filter),Recirculation_Humidity_Calculated)
...
def Recirculation_Humidity_Calculated(G14,G13,Ambient_Humidity,Air_Ingress_Filter,L10,P6):
...
Recirculation_Humidity1_Calculated = 0.01
...
def testrun(Flow_After_Filter_Temp,Ambient_Humidity,Air_Ingress_Filter,Air_Ingress_Mill,System_fan_Heat_Release,Ambient_Absolute_Pressure,Recirculation_Air_Volumetric_Flow,Gas_Flow,Fuel_property_Density,Fuel_Property_Combustion_Water,Combustion_Air_Volumetric_Flow,Combustion_Air_Temp,Moisture,Stucco_Flow,Gypsum_Moisture,HH,AIII,AII,AIII_back_conversion_Converstional_Ratio):
    ...
    Recirculation_Humidity1_Calculated =.1
    while (Recirculation_Humidity1_Calculated<1000):
        G14_1 = 0.1
        G13_1 = 0.1
        ...
        R30_1 = R30(Flow_After_Filter_Temp,Recirculation_Humidity1_Calculated,Air_Ingress_Mill,Air_Ingress_Filter,System_fan_Heat_Release,L41)
        R29_1 = R29(Recirculation_Humidity1_Calculated,Ambient_Absolute_Pressure,R30_1)
        R31_1 = R31(Recirculation_Air_Volumetric_Flow , Recirculation_Humidity1_Calculated , R29_1)
        ...
        L42_1 = L42(Recirculation_Humidity1_Calculated , Gas_Flow , Fuel_Property_Combustion_Water, Combustion_Air_Volumetric_Flow , Combustion_Air_Temp , Ambient_Humidity , Ambient_Absolute_Pressure , L41_1,R31_1)
        ...
        Recirculation_Humidity1_Calculated =Recirculation_Humidity_Calculated(G14_1,G13_1,Ambient_Humidity,Air_Ingress_Filter,L10_1,P6_1)

        print (Recirculation_Humidity1_Calculated,"here")

#print(testrun(Flow_After_Filter_Temp,Ambient_Humidity,Air_Ingress_Filter,Air_Ingress_Mill,System_fan_Heat_Release,Ambient_Absolute_Pressure,Recirculation_Air_Volumetric_Flow,Gas_Flow,Fuel_property_Density,Fuel_Property_Combustion_Water,Combustion_Air_Volumetric_Flow,Combustion_Air_Temp,Moisture,Stucco_Flow,Gypsum_Moisture,HH,AIII,AII,AIII_back_conversion_Converstional_Ratio))
print(R30(Flow_After_Filter_Temp,Recirculation_Humidity1_Calculated,Air_Ingress_Mill,Air_Ingress_Filter,System_fan_Heat_Release,L41))
