...
Bridge_Flow_dry_Flow = 10.10
Air_Ingress_Mill = 10
Air_Ingress_Filter =10
System_fan_Heat_Release = 10
Ambient_Absolute_Pressure = 1003
Flow_After_Filter_Temp = 152.9
Combustion_Air_Temp = 55
Moisture = 0
Stucco_Flow = 31
HH = 72
AIII = 7.8
...
recirculation_air_vol_flow = 9.5
Gas_Flow = 633

Recirculated_Humidity = 0




print (recirculated_hum(Bridge_Flow_dry_Flow,Air_Ingress_Mill,Air_Ingress_Filter,System_fan_Heat_Release,Ambient_Absolute_Pressure,Flow_After_Filter_Temp,Combustion_Air_Temp,Moisture,Stucco_Flow,HH,AIII,gypsum_moisture,Fuel_properties_combustion_water,AII,conversion_ratio,Ambient_Humidity,Recirculated_Humidity,Combustion_Air_Volumetric_Flow,recirculation_air_vol_flow,Gas_Flow))
