...
flow_pressure = 0   # Gas flow Pressure
flow_temperature = 0#Gas flow Temperature
...
def Excess_Air():
    ...
    #as_flow_Nm3 =  lambda Gas_flow_m3 : Gas_flow_m3*(flow_pressure/1.01325)*(273.15/(flow_temperature+273.15))
    ...
    Excess_Air = 100*(COMBUSTION_AIR_DRY_FLOW/MVOL(0, 0, 0)*3600/(Gas_flow_m3*Fuel_properties_Stochiometric_air_factor) - 1)
    return Excess_Air
