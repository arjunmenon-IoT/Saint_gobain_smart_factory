...
HUMIDITY = 335 # iNITIKISED VALUE
Bridge_Flow_dry_Flow = 199 # COMES FROM 'Recirculated  Air Dry flow _ Brdige flow dry flow _ flow after filter temp.py.py'
recirculation_air_dry_flow = 5 # iNTISED 
GAS_FLOW = 651 # INITILISED 
...
print(recirculated_air_energy_flow)