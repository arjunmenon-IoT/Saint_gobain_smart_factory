...
def wrap_all_to_dataset( StartTime,EndTime):
    ...
    def combustion_air_temperature ():
        
        COMBUSTION_AIR_TEMPERATURE_dataset = lambda : system.tag.queryTagHistory(paths=[combustion_air_temperature_path], startDate=starttime, endDate=endtime,intervalHours=2)
    ...
    def ambient_temperature():
        Temp_Avg_data_set= system.tag.queryTagHistory(paths=[temperature_path], startDate=starttime, endDate=endtime, aggregationMode="Maximum",intervalHours=2)
        temp_avg_list = []
    ...
    def DeltaP():
        deltap_dataset = system.tag.queryTagHistory(paths=[delta_p_tag_path], startDate=starttime, endDate=endtime, aggregationMode="Average",intervalHours=2)
        deltap_avg_list = []
    ...
    def Recirculation_Percentage():
        recirculation_Percentage_dataset = system.tag.queryTagHistory(paths=[recirculation_Percentage_tag_path], startDate=starttime, endDate=endtime, aggregationMode="Average",intervalHours=2)
    ...
    def Recirculation_Humidity():
        recirculation_Humidity_dataset = system.tag.queryTagHistory(paths=[recirculation_Humidity_tag_path], startDate=starttime, endDate=endtime, aggregationMode="Average",intervalHours=2)
    ...
    def calcination_temeprature():
        CALCINATION_TEMPERATURE_dataset = lambda : system.tag.queryTagHistory(paths=[calcination_temeprature_path], startDate=starttime, endDate=endtime,intervalHours=2)
    ...
    def Re_circulation_volumeric_flow ():
        Airflowdataset = system.tag.queryTagHistory(paths=[Airflowtagpath], startDate=starttime, endDate=endtime,intervalHours=2)
        circulation_percentage_dataset = system.tag.queryTagHistory(paths=[Re_circulation_percentage_tagpath], startDate=starttime, endDate=endtime,intervalHours=2)
    ...
    CALCINATION_TEMPERATURE= calcination_temeprature()
    STUCCO_FLOW = 31.00
    #Weather Inputs
